    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('surat.update', $surat->id_surat) }}" method="post" enctype="multipart/form-data" class="form-horizontal"> 
                    @method('put')
                    {{ csrf_field() }}
                    <div class="row form-group">
                        ...
                        <input type="text" id="text-input" name="jenis_surat" value="{{ $surat->jenis_surat }}" placeholder="Maksimal 50 karakter" class="form-control" maxlength="50">
                        </div>
                    </div>
                    <div class="menudata">
